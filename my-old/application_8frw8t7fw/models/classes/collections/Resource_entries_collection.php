<?php
	...
	*/
	...
	class Resource_entries_collection extends Standard_collection {
		...
		**/
		public function get_categorized( $category_ids ) {
			...
			$obj_new_collection	= new resource_entries_collection();
		...
		public function get_category_ids() {
			...
			foreach( $arr_collection as $obj_entry ) {
				...
				foreach( $arr_tmp_cats as $arr_cat ) {
					$arr_return[$arr_cat['resource_entry_category_id']]	= $arr_cat['resource_entry_category_id'];
				}
		...
		**/
		public function get_categories() {
			...
			foreach( $arr_category_ids as $category_id ) {
				...
				$arr_category_collections[$category_id]->set('category_id', $arr_categories[$category_id]['resource_entry_category_id']);
		...
		public function get_tags() {
			...
			foreach( $arr_collection as $obj_entry ) {
				...
				foreach( $arr_tags as $arr_tag ) {
					$arr_rtn[$arr_tag['resource_entry_tag_id']]	= $arr_tag['name'];
				}
