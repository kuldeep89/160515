<?php
	...
	*/	
	...
	$arr_js[]	= 'scripts/save-academy-entry.js';
...
?>
                  ...
                  <div class="row-fluid">
                     <div class="span8 blog-tag-data">
                                 ...
                                 <li>
									...
									<?php if( count($arr_tags) > 0 ) : ?>
										...
										<?php foreach( $arr_tags as $arr_tag ) : ?>
											...
											<a href="<?php echo site_url('academy/tag/'.$arr_tag['academy_entry_tag_id']); ?>"><?php echo $arr_tag['name']; ?></a>
                        ...
                        <?php if( !empty($image) && !is_null($image) ): ?>
							<img src="<?php echo $image; ?>" class="content-image featured-image-preview" style="float: right;"  />
					   <?php else: ?>
					   		<img src="http://www.placehold.it/1x1/EFEFEF/AAAAAA&text=no+image" class="featured-image-preview no-content-image" style="float: right; max-width: 325px; padding-left: 10px; padding-bottom: 10px;" />
						<?php endif; ?>
                        	...
                        	<?php if( count($arr_categories) > 0 ) : ?>
                        		...
                        		<?php $first = TRUE; ?>
								<?php foreach( $arr_categories as $arr_category ) : ?><?php if( !$first ) echo ', '; ?><a href="<?php echo site_url('academy/category/'.$arr_category['academy_entry_category_id']); ?>"><?php echo $arr_category['name']; ?></a><?php $first = FALSE; ?><?php endforeach; ?>
		                        ...
		                        <div class="span12 ">
		                        	<div class="portlet box grey">
		                        		...
		                        		<div class="portlet-body form">
			                        		...
			                        		<form action="<?php echo site_url('academy/update-entry/'.$obj_entry->get('id')); ?>" class="form-horizontal" id="academy-entry-form" method="post">
											    ...
											    <div class="control-group">
											    	...
											    	<div class="controls">
											    		...
											    		<a href="#myModal1" role="button" class="btn btn-primary" data-toggle="modal" onclick="retrieve_academy_images()">Select Featured Image</a>
											    ...
											    <div class="form-actions">
											        ...
											        <?php if( $this->security_lib->accessible(1) ) : ?><a id="add-another-entry" href="<?php echo site_url('academy/create-entry'); ?>" type="submit" class="btn yellow">Add Another Entry</a><?php endif; ?>
											        <?php if( $this->security_lib->accessible(3) ) : ?><a href="<?php echo site_url('academy/remove-entry/'.$obj_entry->get('id')); ?>" class="btn red confirm-delete">Delete</a><?php endif; ?>
                     ...
                     <div class="span4">
                        ...
                        <?php
                        	$this->load->view('backend/object-templates/academy/article-teasers', array('obj_entry_collection' => $obj_related_collection));
                        ?>
                        ...
                        <ul class="unstyled inline sidebar-tags">
                        	...
                        	<?php if( count($arr_all_tags) > 0 ) : ?>
                        		...
                        		<?php foreach( $arr_some_tags as $arr_tag ) : ?>
                        			...
                        			<li><a href="<?php echo site_url('academy/tag/'.$arr_tag['academy_entry_tag_id']); ?>"><i class="icon-tags"></i> <?php echo $arr_tag['name']; ?></a></li>
		...
		<div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
			<div class="modal-header">
				...
				<h3 id="myModalLabel1">Academy Images</h3>
			</div>
				...
				<!--BEGIN TABS-->
	              <div class="tabbable tabbable-custom">
	                 <ul class="nav nav-tabs">
	                    <li class="active"><a href="#tab_1_1" id="view-academy-images" data-toggle="tab">Select Featured Image</a></li>
	                    <li><a href="#tab_1_2" id="upload-image" data-toggle="tab">Upload Image</a></li>
	                 </ul>
	                 <div class="tab-content">
	                    <div class="tab-pane active" id="tab_1_1" style="overflow: hidden;">
	                       <div class="featured-images tiles">
							   <div id="media_loading" class="media_transparent">
		                       		<img src="<?php echo site_url('assets/img/media_loading.gif') ?>" baseurl="<?php echo site_url('assets/img/media_loading.gif') ?>" style="padding-top: 35%;" />
		                       </div>
						   </div>
	                    </div>
	                    <div class="tab-pane" id="tab_1_2">
							<iframe id="upload_iframe" src="<?php echo site_url('media/upload/academy'); ?>" uploadpath="<?php echo site_url('media/upload/academy'); ?>" width="100%" height="360" border="0" style="border: none;"></iframe>
	                    </div>
	                 </div>
	              </div>
	              <!--END TABS-->
