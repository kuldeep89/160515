...
?>
	...
	<?php
		...
		$arr_js[]	= 'scripts/resource_listing.js';
                	...
                	<!-- BEGIN EXAMPLE TABLE PORTLET-->
	                  <div class="portlet box light-grey">
	                     <div class="portlet-title">
	                        <div class="caption"><i class="icon-globe"></i>Resource Entries</div>
	                        <div class="tools">
	                     ...
	                     <div class="portlet-body">
	                        <div class="clearfix">
	                           <div class="btn-group">
	                              <a href="<?php echo site_url('resource/create-entry'); ?>" id="sample_editable_1_new" class="btn green">
		                    ...
		                    <?php
								$this->load->view('backend/object-templates/resource/entry-collection');
							?>
