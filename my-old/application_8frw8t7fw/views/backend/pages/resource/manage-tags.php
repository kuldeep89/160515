		            ...
		            <div class="span12">
		                ...
		                <div class="portlet box light-grey">
		                    ...
		                    <div class="portlet-body">
		                    	<div class="btn-group">
	                              <a href="<?php echo site_url('resource/add-tag'); ?>" id="sample_editable_1_new" class="btn green">
		                            	...
		                            	<?php if( isset($arr_tags) && count($arr_tags) > 0 ) : ?>
									   		...
									   		<?php foreach( $arr_tags as $arr_tag ) : ?>
									   				...
									   				<tr class="odd gradeX">
									   					...
									   					<td><input type="checkbox" class="checkboxes" value="<?php echo $arr_tag['resource_entry_tag_id']; ?>" /></td>
									   					<td><?php echo $arr_tag['resource_entry_tag_id']; ?></td>
														<td><?php echo $arr_tag['name']; ?></td>
														<td><?php echo $arr_num_in_tags[$arr_tag['resource_entry_tag_id']]; ?></td>
														<td><span class="label label-success"><a href="<?php echo site_url('resource/edit-tag/'.$arr_tag['resource_entry_tag_id']); ?>">Edit</a> | <a href="<?php echo site_url('resource/remove-tag/'.$arr_tag['resource_entry_tag_id']); ?>" class="confirm-delete">Delete</a></span></td>
														<td><a href="<?php echo site_url('resource/tag/'.$arr_tag['resource_entry_tag_id']); ?>">View Tagged Entries</a></td>
													</tr>
