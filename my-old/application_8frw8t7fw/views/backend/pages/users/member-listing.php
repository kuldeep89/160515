                	...
                	<!-- BEGIN EXAMPLE TABLE PORTLET-->
	                  <div class="portlet box light-grey">
	                     <div class="portlet-title">
	                        <div class="caption"><i class="icon-globe"></i>Member Listing</div>
	                        <div class="tools">
	                     ...
	                     <div class="portlet-body">
	                        <div class="clearfix">
	                           <div class="btn-group">
	                              <a href="<?php echo site_url('users/add-member'); ?>" id="sample_editable_1_new" class="btn green">
	                              Add New Member <i class="icon-plus"></i>
	                              </a>
	                           </div>
							...
							<?php $this->load->view('backend/object-templates/users/user-listing'); ?>
