<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">   
    <head>	
        ...
        <link rel="stylesheet" type="text/css" href="./assets/css/pages/maintenance_mode/style.css" />
        <!--[if IE]>
			<link rel="stylesheet" type="text/css" href="./css/ie.css" />
		<![endif]-->
        <style type="text/css">
        	body {
				background: url(./assets/img/pages/background.jpg) no-repeat center center fixed; 
            ...
            #subscribe {
	            background: url(./assets/img/pages/arrow.png) no-repeat center center;
            ...
            #MERGE0 {
	            padding-left: 65px;
	            background: url(./assets/img/pages/email.png) no-repeat 20px center;
	            height: 50px;
	            width: 80%;
	            color: #fff;
	            font-size: 18px;
            ...
            @media (max-width: 400px) {
            	#subscribe {
	            	background-image: url(./assets/img/pages/subscribe.png);
            	}
            }
        </style>
    </head>
    <body>
        ...
        <div id="content">
			...
			<div id="social-media">
				<div>CONNECT</div>
				<a href="https://www.facebook.com/Saltsha" target="_blank"><img src="./assets/img/pages/fb.png" alt="facebook" /></a>
				<a href="https://plus.google.com/105387137872967257002" target="_blank" rel="publisher"><img src="./assets/img/pages/gplus.png" alt="Google+" /></a>
				<a href="https://twitter.com/saltsha" target="_blank"><img src="./assets/img/pages/tw.png" alt="twitter" /></a>
			</div>
        </div>
