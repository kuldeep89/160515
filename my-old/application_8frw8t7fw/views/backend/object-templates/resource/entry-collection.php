                           ...
                           <tbody>
							   ...
							   <?php if( isset($obj_entry_collection) && $obj_entry_collection->size() > 0 ) : ?>
							   		...
							   		<?php foreach( $arr_entries as $obj_entry ) : ?>
							   			...
							   			<?php if( $obj_entry->get('initial') != 1 || $obj_entry->get('author_id') == $this->current_user->get('id') || $obj_entry->get('created_by') == $this->current_user->get('id') ) : ?>
							   				...
							   				<?php // Keaton: hidden checkboxes ; ?>
												...
												<td><a href="<?php echo site_url('resource/entry/'.$obj_entry->get('id')); ?>"><?php echo $obj_entry->get('title'); ?></a>
												...
												<td><span class="label label-success"><a href="<?php echo site_url('resource/entry/'.$obj_entry->get('id')); ?>">Edit</a> | <a href="<?php echo site_url('resource/remove-entry/'.$obj_entry->get('id')); ?>" class="confirm-delete">Delete</a></span></td>
											</tr>
								...
								<?php else : ?>
									...
									<tr class="odd gradeX">
										<td colspan="6">There are currently no resource entries.</td>
									</tr>  
