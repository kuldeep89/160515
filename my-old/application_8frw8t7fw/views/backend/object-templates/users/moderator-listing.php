			   ...
			   <?php if( isset($obj_user_collection) && $obj_user_collection->size() > 0 ) : ?>
			   		...
			   		<?php foreach( $obj_user_collection->get('arr_collection') as $obj_user ) : ?>
		   				...
		   				<tr class="odd gradeX">
							...
							<td><a href="<?php echo site_url('users/moderator/'.$obj_user->get('id')); ?>"><?php echo $obj_user->get('username'); ?></a></td>
							...
							<td><span class="label label-success"><a href="<?php echo site_url('users/moderator/'.$obj_user->get('id')); ?>">Edit</a> | <a href="<?php echo site_url('users/remove-moderator/'.$obj_user->get('id')); ?>" class="confirm-delete">Delete</a></span></td>
						</tr>
