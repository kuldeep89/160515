...
if (!function_exists('FoundationPress_scripts')) :
  function FoundationPress_scripts() {
    ...
    wp_register_script( 'flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js', array(), '1.0.0', true );
    wp_register_script( 'my_scripts', get_template_directory_uri() . '/js/my-scripts.js', array(), '1.0.0', true );
