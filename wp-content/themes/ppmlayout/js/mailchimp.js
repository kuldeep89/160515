...
function mce_preload_check(){
    ...
    var script = document.createElement('script');
    script.type = 'text/javascript';
    script.src = '/wp-content/themes/ppmlayout/js/jquery.form-n-validate.js';
    head.appendChild(script);
    try {
...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://paypromedia.us7.list-manage.com/subscribe/post-json?u=e81d58b75c4280863de8148c2&id=3f7cb79cb9&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
