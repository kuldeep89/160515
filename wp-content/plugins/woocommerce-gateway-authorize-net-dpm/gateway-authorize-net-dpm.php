...
function woocommerce_authorize_dpm_init() {
	...
	class WC_Gateway_Authorize_DPM extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->auth_only       = isset( $this->settings['auth_only'] ) && $this->settings['auth_only'] == 'yes' ? true : false;
	    ...
	    public function init_form_fields() {
	    	...
	    	$this->form_fields = array(
				...
				'auth_only' => array(
					'title'       => __( 'Authorize Only', 'wc-authorize-dpm' ),
					'type'        => 'checkbox',
					'label'       => __( 'Enable Authorize Only Mode', 'wc-authorize-dpm' ),
					'description' => __( 'Check this to disable instant capture of funds and authorize the credit card only upon checkout.', 'wc-authorize-dpm' ),
					'default'     => 'no'
				),
				'testmode' => array(
		...
		public function receipt_page( $order_id ) {
			...
			echo WC_Authorize_Net_DPM::getCreditCardForm( $amount, $order_id, $this->relay_response_url, $this->api_login, $this->transaction_key, $this->testmode, $this->testmode, $order, $this->auth_only );
		}
