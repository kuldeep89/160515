      ...
      if (!isset($message['retweeted_status']) ) {
        $message['retweeted_status'] = array();
			...
			if($options['update']) {				
				...
				$h_time = ( ( abs( time() - $time) ) < 86400 ) ? sprintf( __('%s', 'rstw'), human_time_diff( $time )) : date($options['date_format'], $time);
				$out .= '<span class="rstw_comma">,</span><div><div class="twitter-timestamp" title="' . date(__('Y/m/d H:i', 'rstw'), $time) . '">' . str_replace(array('days','day','hours','hour','minutes','mins','minute','min','seconds','second',' '), array('d','d','h','h','m','m','m','m','s','s',''), $h_time) . '</div><div class="twitter-tools"><a href="https://twitter.com/intent/tweet?in_reply_to='.$message['id_str'].'"><img src="/wp-content/themes/ppmlayout/assets/img/twitter-reply.png" /> Reply</a> <a href="https://twitter.com/intent/retweet?tweet_id='.$message['id_str'].'"><img src="/wp-content/themes/ppmlayout/assets/img/twitter-retweet.png" /> Retweet</a> <a href="https://twitter.com/intent/favorite?tweet_id='.$message['id_str'].'"><img src="/wp-content/themes/ppmlayout/assets/img/twitter-favorite.png" /> Favorite</a></div></div>';
			}          
