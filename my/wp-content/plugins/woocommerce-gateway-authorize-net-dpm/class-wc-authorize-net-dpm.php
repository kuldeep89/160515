...
class WC_Authorize_Net_DPM extends AuthorizeNetDPM {
     ...
     * @return string
     */
    public static function getCreditCardForm($amount, $fp_sequence, $relay_response_url, $api_login_id, $transaction_key, $test_mode = true, $prefill = true, $order = '', $auth_only = false )
    {
        $time = time();
        ...
        $sim = new AuthorizeNetSIM_Form(
            array(
                ...
                'x_type'               => $auth_only ? 'AUTH_ONLY' : 'AUTH_CAPTURE'
            )
        );
