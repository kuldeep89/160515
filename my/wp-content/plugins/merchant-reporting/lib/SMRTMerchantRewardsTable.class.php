<?php
class SMRTMerchantRewardsTable extends WP_List_Table {
    ...
    function column_default( $item, $column_name ) {
        switch( $column_name ) {
            ...
            case 'reward_points':
                return (isset($item[ $column_name ]) && trim($item[ $column_name ]) !== '') ? $item[ $column_name ] : '0';
            default:
    ...
    function get_columns(){
        $columns = array(
            ...
            'reward_points' => __( 'Reward Points', 'smrt_stats_table' ),
