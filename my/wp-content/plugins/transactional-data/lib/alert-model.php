	...
	class alert_model {
		...
		*/
		public function get_user_mailer_variables( $merchant_id, $timeframe, $end_time, $title) {
			...
			$get_batches = $mysqli->query("SELECT uniq_batch_id FROM ".$table_prefix."ppttd_batchlisting WHERE merchant_id = '".$merchant_id."' AND batch_date BETWEEN '".$timeframe."' AND '".$end_time."' ORDER BY batch_date DESC");
