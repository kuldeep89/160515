...
$cart_or_quote = ($woocommerce->cart->has_quoted_item == false) ? 'Add To Cart' : 'Add To Quote';
?>
...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="cart" method="post" enctype='multipart/form-data'>
				...
				<tr>
					<td>
						...
						<?php elseif ( ! $quantites_required ) : ?>
							...
							<a href="<?php echo esc_url( $child_product['product']->add_to_cart_url() ); ?>" rel="nofollow" class="single_add_to_cart_button button alt"><?php echo apply_filters( 'single_add_to_cart_text', $cart_or_quote, $child_product['product']->product_type ); ?></a>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt"><?php echo apply_filters('single_add_to_cart_text', $cart_or_quote, $product->product_type); ?></button>
