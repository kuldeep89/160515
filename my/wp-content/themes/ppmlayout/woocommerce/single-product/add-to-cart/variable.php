...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo $post->ID; ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
	...
	<div class="single_variation_wrap" style="display:none;">
		...
		<div class="variations_button">
			...
			<?php $cart_or_quote = ($woocommerce->cart->has_quoted_item == false) ? 'Add To Cart' : 'Add To Quote' ?>
			<button type="submit" class="single_add_to_cart_button button alt"><?php echo apply_filters('single_add_to_cart_text', __( $cart_or_quote, 'woocommerce' ), $product->product_type); ?></button>
		</div>
	</div>
	<div>
