		...
		<table cellspacing="0">
			<tbody>
				...
				<!-- <tr class="cart-subtotal">
					...
					<?php
						// Get current line total and add to final total
				...
				<?php if ( $woocommerce->cart->get_discounts_before_tax() ) : ?>
					...
					<tr class="discount">
						<th><?php echo ($woocommerce->cart->has_quoted_item == false) ? 'Cart Discount' : 'Quote Discount' ?> <a href="<?php echo add_query_arg( 'remove_discounts', '1', $woocommerce->cart->get_cart_url() ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></th>
				...
				<?php if ( $woocommerce->cart->get_discounts_after_tax() ) : ?>
					...
					<tr class="discount">
						<th><?php echo ($woocommerce->cart->has_quoted_item == false) ? 'Order Discount' : 'Quote Discount' ?> <a href="<?php echo add_query_arg( 'remove_discounts', '2', $woocommerce->cart->get_cart_url() ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></th>
				...
				<tr class="total">
					...
					<th><?php echo ($woocommerce->cart->has_quoted_item == true) ? '' : '<strong>'._e( 'Total', 'woocommerce' ).'</strong>' ?><strong></th>

					<td>

						<?php echo ($woocommerce->cart->has_quoted_item == true) ? '<em>Total due determined after quote has been reviewed.</em>' : $woocommerce->cart->get_total(); ?>
